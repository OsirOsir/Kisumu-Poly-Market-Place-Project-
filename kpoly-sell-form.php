 ...
 * Description: Frontend shortcode form for submitting marketplace listings as pending WooCommerce products.
 * Version: 1.2.0
 * Author: KPoly Market
 * License: GPL2+
...
if (!class_exists('KPoly_Sell_Form')) {
    ...
    class KPoly_Sell_Form {
        ...
        public function render_shortcode(): string {
            ...
            <div class="kpoly-sell-form-wrap">
                ...
                <form class="kpoly-sell-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="kpoly-form-group">
                        <button type="submit" class="kpoly-submit-btn">Submit Listing</button>
                    </div>
                </form>
            </div>
        ...
        public function handle_form_submission(): void {
            ...
            $product_id = $this->create_pending_product($data);
...
if (
    ...
    $errors[] = 'Please select a valid category.';
        ...
        private function create_pending_product(array $data) {
