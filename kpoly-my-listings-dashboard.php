            ...
            <article class="kpoly-my-card">
                ...
                <div class="kpoly-my-card-body">
                    ...
                    <div class="kpoly-my-card-meta">
                        ...
                        <span>📄 Status: <?php echo esc_html(ucfirst($status)); ?></span>
                        <span>🗓 Posted: <?php echo esc_html(get_the_date('M j, Y', $product_id)); ?></span>
                    </div>

                    <span class="kpoly-my-card-status"><?php echo esc_html(ucfirst($status)); ?></span>
                    ...
                    <div class="kpoly-my-card-actions">
                        ...
                        <a class="kpoly-my-btn kpoly-my-btn-delete" href="<?php echo esc_url($delete_link); ?>">Delete</a>
                        <a class="kpoly-my-btn kpoly-my-btn-sold" href="<?php echo esc_url($sold_link); ?>">Mark Sold</a>
                    </div>
                </div>
            </article>
            <?php
